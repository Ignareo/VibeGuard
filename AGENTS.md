...
- Only add tests to packages that already have them: `internal/proxy`, `internal/session`, `internal/rulelists`, `internal/promptredact`, `internal/restore`, `internal/stream`, `internal/textsafe`, `internal/wsproxy`, `internal/ahocorasick`, `internal/admin`, `internal/secretsources`, `internal/pii_next/rulelist`, `internal/pii_next/ner`.
